...
/**
 * This class stands for GetCurrencyUnitsRequestBody StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetCurrencyUnitsRequestBody
 * @subpackage Structs
 */
class GetCurrencyUnitsRequestBody extends AbstractStructBase
{
    /**
     * The currencyNames
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetCurrencyUnitsRequestBody
     * @uses GetCurrencyUnitsRequestBody::setCurrencyNames()
     * @param string $currencyNames
     */
    public function __construct($currencyNames = null)
    {
        $this
     ...
     * @param string $currencyNames
     * @return \MnbClient\StructType\GetCurrencyUnitsRequestBody
     */
